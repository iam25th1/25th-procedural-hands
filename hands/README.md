...
| Palm | Lighter and pinker than the back on every tone, the gap widening with depth: a few L* on Monk 1 to 5, up to about 33 L* on Monk 10, as palmar skin carries far less melanin. Only glabrous skin gets it: the palm and the volar side of the digits, stopping at the wrist crease (half at the crease ring). The volar forearm faces the same way but is ordinary skin, so it keeps the dorsal colour (Yamaguchi et al. J Cell Biol 2004: palmoplantar melanocyte density is a fifth of other sites') |
