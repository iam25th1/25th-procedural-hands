...
| Thumb column rest rotation | first metacarpal rotation at rest 74.1 deg on both hands (the column rolled -24.2 deg about its own axis; the unrolled hint read 41.6); the power-grip pre-shape's CMC abduction 37 deg, the joint's limit (authored at 40, past it) | Cheema TA, Cheema NI, Tayyab R, Firoozbakhsh K. J Hand Surg Am 2006;31(1):76-79: axial CT angle between the dorsal tangent of the 2nd and 3rd metacarpals and the line through the 1st metacarpal head at the sesamoids, 74 +/- 10 deg at rest | `anatomy: first metacarpal rotation at rest within one SD of Cheema 2006` |
